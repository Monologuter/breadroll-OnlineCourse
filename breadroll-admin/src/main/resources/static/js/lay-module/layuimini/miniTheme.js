            ...
            var bgColorConfig = [
                {
                    ...
                    leftMenuBgThis: '#009688', //左侧菜单选中背景,
                    leftMenuChildBg: '#282B33', //左侧菜单子菜单背景,
                    leftMenuColor: '#fff', //左侧菜单字体颜色,
                    leftMenuColorThis: '#409EFF', //左侧菜单选中字体颜色,
                    tabActiveColor: '#ff4d4f', //tab选项卡选中颜色,
                },
                {
        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<a class="more-menu-item" href="http://mall.qiudb.top/" target="_blank"><i class="layui-icon layui-icon-cart-simple" style="font-size: 19px;"></i> 花卷商城</a>\n' +
